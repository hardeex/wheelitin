    ...
    <div class="max-w-2xl w-full text-center">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8 mb-8">
            ...
            <div class="mt-6 grid md:grid-cols-3 gap-4 text-sm">
                <a href="{{ route('about') }}" class="flex items-center justify-center space-x-2 text-[var(--color-dark-blue)]/70 hover:text-[var(--color-sky-blue)] py-3 px-4 rounded-lg hover:bg-[var(--color-baby-blue)]/20 transition-colors">
