...
<section class="relative overflow-hidden"
    ...
    <div class="h-[520px] sm:h-[560px] md:h-[650px] lg:h-[722px] w-full max-w-[1440px] mx-auto px-4 sm:px-6 relative">
        ...
        <div class="flex flex-col items-center justify-start pt-16 sm:pt-20 md:pt-24 lg:pt-16 xl:pt-20">
            ...
            <h1
                ...
                <span class="block">Test auto deployment Book Trusted Local Mechanics In Minutes</span>
   ...
   class=" font-displayrelative z-50 bg-[var(--color-dark-blue)] text-white px-9 sm:px-10 md:px-12 py-3 sm:py-3 md:py-4 rounded-full font-semibold hover:bg-opacity-90 hover:scale-105 transition-all duration-300 text-[15px] sm:text-[16px] md:text-[18px] shadow-lg animate-fade-in-up"
   style="animation-delay: 0.4s;">
    Join Waitlist
        ...
        <div
            class="absolute top-4 right-3 sm:top-12 sm:right-6 md:top-16 md:right-8 lg:top-[140px] lg:right-[30px] z-30">
        ...
        <div
            class="absolute bottom-0 left-0 right-0 flex items-end justify-center h-[150px] sm:h-[180px] md:h-[240px] lg:h-[280px] xl:h-[300px]">
            <!-- Cars Image -->
            ...
            <div
                class="
        absolute
        bottom-[-15px] sm:bottom-[-50px] md:bottom-[-100px] lg:bottom-[-160px]
        left-1/2 -translate-x-1/2
        sm:left-[38%] sm:-translate-x-1/2
        z-10
    ">
                <img src="{{ asset('images/pushing-car.gif') }}" alt="Cars"
                    class="w-[260px] sm:w-[380px] md:w-[550px] lg:w-[700px] h-auto">
            </div>
