...
<section class="relative overflow-hidden" style="background: linear-gradient(180deg, #FDF3DA 28%, #8ECAE6 50%, #219EBC 100%);">
    <div class="h-[450px] sm:h-[500px] md:h-[550px] lg:h-[600px] w-full max-w-[1440px] mx-auto px-4 sm:px-6 relative">
        ...
        {{-- <!-- Bottom Section - People and Map Icon -->
        <div class="absolute bottom-0 right-0 flex items-end gap-4 sm:gap-6 md:gap-8 lg:gap-12 pr-4 sm:pr-8 md:pr-16 lg:pr-24 pb-0">
            <!-- Map Icon - beside the people -->
            ...
            <!-- About Hero Image (3 people) -->
            <div class="relative z-10 left-50">
