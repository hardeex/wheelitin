...
<footer class="relative bg-[var(--color-dark-blue)] text-white overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-32 h-32 bg-[var(--color-orange)] rounded-tr-full"></div>
    <div class="absolute bottom-0 right-0 w-32 h-32 bg-[var(--color-orange)] rounded-tl-full"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            ...
            <div class="flex flex-col items-start md:items-end justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="#" class="w-12 h-12 bg-[var(--color-orange)] rounded-full flex items-center justify-center hover:bg-[var(--color-sun)] transition-colors">
